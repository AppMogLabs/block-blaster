 ...
 *
 * The approve tx costs a tiny amount of MegaETH testnet ETH; the auto-drip
 * fired from useBlok covers it for new wallets.
 */
export function ApproveBanner() {
  ...
  // immediately after a fresh /api/balance fetch returns 0 allowance. If
  // the user already approved, a subsequent refresh would flip approved
  // true quickly. Wait 500ms after `ready` becomes true before showing the
  // banner so a stable "not approved" state doesn't flash up for users who
