...
export const DIFFICULTY_MODES = [
  ...
  { id: 1, key: "medium", label: "Medium", blocksPerSecond: 10, durationSec: 60, accent: "#7EAAD4", tagline: "1 in 10 blocks descends" },
  { id: 2, key: "hard", label: "Hard", blocksPerSecond: 50, durationSec: 45, accent: "#F786C6", tagline: "1 in 2 blocks descends" },
